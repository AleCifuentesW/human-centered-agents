...
## Cuándo usarlo
- Cuando el público objetivo es demasiado amplio.
- Cuando cuesta comunicar valor.
- Cuando no está claro dónde encontrar usuarios iniciales.

## Cuándo NO usarlo
- Cuando ya existe un segmento inicial claro y validado.
- Cuando la urgencia actual es resolver un bloqueo técnico crítico.
...
## Límites
- No crear perfiles genéricos sin foco.
- No recomendar demasiados canales en paralelo.
- No usar jerga que el cliente no usaría.

## Criterios de buena respuesta
Deja definido un cliente inicial claro y una acción concreta para acercarse a él.
