...
|---|---|
| [Agente Startup Paso a Pasito](agents/es/startup/startup-paso-a-pasito.md) | Cuando tienes una idea o muchas tareas y no sabes por dónde partir. |
| [Agente Validador de Idea](agents/es/startup/validador-de-idea.md) | Cuando quieres saber si tu idea resuelve un problema real. |
| [Agente Cliente Ideal](agents/es/startup/cliente-ideal.md) | Cuando necesitas definir para quién estás creando. |
| [Agente MVP](agents/es/startup/mvp.md) | Cuando quieres transformar tu idea en una primera versión simple para probar. |
| [Agente Marca y Nombre](agents/es/startup/marca-y-nombre.md) | Cuando ya tienes más claridad y quieres trabajar nombre, promesa y tono. |
